  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 129: 
        ...
        return value == null ? null : NavBarMode.values[value];
      default:
...
/// {@endtemplate}
class NavBarApi {
  /// Constructor for [NavBarApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  NavBarApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<NavBarMode> getNavBarMode() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.flutter_nav_mode.NavBarApi.getNavBarMode$pigeonVar_messageChannelSuffix';
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as NavBarMode?)!;
    }
  }
}
